 ...
 * Created by vijsu on 04-09-2017.
 */
 ...
 *
 *     Glide.with(this)
 *         .using(new com.studioemvs.chrysalis.FirebaseImageLoader())
 *         .load(ref)
 *         .into(iv);
 * </pre>
 */
public class FirebaseImageLoader implements StreamModelLoader<StorageReference> {
    ...
    private static final String TAG = "com.studioemvs.chrysalis.FirebaseImageLoader";
